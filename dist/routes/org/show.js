...
exports.showOrgRouter = router;
router.get("/:id", requireAuth_1.requireAuth, (0, paramsChecker_1.paramsChecker)("id"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const org = yield Organisation_1.default.findById(req.params.id);
    if (!!!org)
        throw new NotFound_1.NotFound("Organisation not found");
    if (!org.users.includes(req.currentUser.userId))
        throw new BadRequest_1.BadRequest("You dont have access to this org");
    res.status(200).json({
        status: "success",
        message: "Load data",
        data: org,
